const page = () => {
  return (
    <div className=" max-w-[635px] px-8 drop-shadow-[0_15px_30px_rgba(0,81,171,0.1488)] md:px-0">
      <div className="grid overflow-hidden rounded-lg  ">
        <div className="  bg-white px-6 pt-7 pb-8 md:p-10 ">
          <h1 className=" mb-6 text-xl font-bold -tracking-[0.25px] text-cyan">
            Join our community
          </h1>
          <p className=" mb-4 text-[15px] font-bold leading-5 -tracking-[0.19px] text-yellow-bright md:mb-[11px]">
        ...
        <div className="flex flex-col bg-cyan md:flex-row  ">
          <div className=" p-6 md:w-1/2 md:p-10">
            ...
            <button className=" w-full rounded-[5px] bg-yellow-bright py-[14px] text-base  text-white drop-shadow-[0_10px_10px_rgba(0,0,0,0.0973)] ">
              Sign Up
            </button>
          </div>
          <div className="bg-white bg-opacity-[15.19%] p-6 md:w-1/2 md:p-10">
